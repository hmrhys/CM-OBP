...
public class MappingController {
     ...
     * @return contents of the page
     */
    @GetMapping ( { "/addRecipe2", "/addRecipe2.html" } )
    public String addRecipeForm ( final Model model ) {
        return "addRecipe2";
    }

    /**
     * On a GET request to /frontend, the MakeCoffeeController will return
     * /src/main/resources/templates/frontend.html.
     *
     * @param model
     *            underlying UI model
     * @return contents of the page
     */
    @GetMapping ( { "/frontend", "/frontend.html" } )
    public String frontendForm ( final Model model ) {
        return "frontend";
    }
